...
public:
     ...
     * @param transformMatrixUniformName The name of your model/view/projection matrix uniform
...
-    * @param transformMatrix sixteen floats, column major, defining an OpenGL projection matrix.
     */
    void setTransformMatrix(float* transformMatrix) const;
